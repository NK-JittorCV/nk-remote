...
from jrs.data.devkits.ImgSplit_multi_process import process
from jrs.data.devkits.convert_data_to_mmdet import convert_data_to_mmdet
from jrs.data.devkits.fair_to_dota import fair_to_dota
from jrs.utils.general import is_win

from jrs.data.devkits.ssdd_to_dota import ssdd_to_dota
