from jrs.utils.registry import HEADS, LOSSES, BOXES, build_from_cfg
from jrs.models.utils.modules import ConvModule
from jrs.ops.dcn_v1 import DeformConv
from jrs.ops.bbox_transforms import obb2poly, poly2obb
from jrs.utils.general import multi_apply, unmap
from jrs.ops.nms_rotated import multiclass_nms_rotated
from jrs.models.boxes.anchor_target import images_to_levels
from jrs.ops.reppoints_convex_iou import reppoints_convex_iou
from jrs.ops.reppoints_min_area_bbox import reppoints_min_area_bbox
from jrs.models.boxes.box_ops import rotated_box_to_poly
...
class RotatedRepPointsHead(nn.Module):
    ...
    def _point_target_single(self,
        ...
        # if stage != 'init':
        #     import pickle
        #     input_dict = pickle.load(open("/mnt/disk/flowey/remote/JRS-debug/weights/input_dict.pkl", "rb"))
        ...
        #     result_list = pickle.load(open("/mnt/disk/flowey/remote/JRS-debug/weights/result_dict.pkl", "rb"))
