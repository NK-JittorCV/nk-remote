...
from jrs.models.losses.focal_loss import sigmoid_focal_loss
from jrs.models.losses.smooth_l1_loss import smooth_l1_loss
from jrs.models.roi_heads.anchor_generator import bbox2loc, bbox_iou, loc2bbox, loc2bbox_r, bbox2loc_r
from jrs.ops import box_iou_rotated
from jrs.utils.registry import HEADS
from jittor import nn,init 
import jittor as jt
from jrs.utils.registry import build_from_cfg,MODELS
import numpy as np
import jrs
from jrs.models.boxes.box_ops import rotated_box_to_bbox, boxes_xywh_to_x0y0x1y1, boxes_x0y0x1y1_to_xywh
        ...
        for i,target in enumerate(targets):
            ...
            for j in range(self.n_class):
                ...
                if (self.mode == 'H'):
                    ...
                    keep = jrs.ops.nms_rotated.nms_rotated(bbox_j,score_j,self.nms_thresh)
        ...
        for x in xs:
            ...
            for i,target in enumerate(targets):
                if self.is_training():
                    ...
                    # from jrs.models.boxes.box_ops import rotated_box_to_poly_single
                    # from jrs.utils.visualization import draw_poly
                    # import cv2
