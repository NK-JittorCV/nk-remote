...
def main():
    ...
    ours_weights_path = f'/mnt/disk/cxjyxx_me/JAD/JRS/projects/retinanet/exp/{model}/checkpoints/ckpt_1.pkl'
    yx_weights_path = 'cache_check/i1.pk_jt.pk'
    check_diff(ours_weights_path, yx_weights_path)

    # ours_weights_path = f'/mnt/disk/cxjyxx_me/JAD/JRS/projects/retinanet/exp/{model}/checkpoints/ckpt_0.pkl'
