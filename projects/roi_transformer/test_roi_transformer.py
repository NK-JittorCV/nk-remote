...
def main():
    ...
    if (args.set_data):
        ...
        for batch_idx in range(len(imagess)):
            ...
            # targets['gt_labels'] = jrs.utils.general.to_jt_var(targets['gt_labels'])
            # targets['gt_bboxes_ignore'] = jrs.utils.general.to_jt_var(targets['gt_bboxes_ignore'])
            # targets['gt_bboxes'] = jrs.utils.general.to_jt_var(targets['gt_bboxes'])
